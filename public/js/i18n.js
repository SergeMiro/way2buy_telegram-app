...
(function () {
  ...
  var entries = [
    ...
    // The fitting room asks a question — «is it in stock, what does it cost» —
    // and every string here names that ask rather than the act of messaging.
    ['Запит на наявність і ціну', 'Availability & price request', 'Запрос наличия и цены'],
    ['Дізнатися наявність і ціну', 'Check availability & price', 'Узнать наличие и цену'],
    ['Необовʼязково: розмір, колір або питання', 'Optional: size, colour or a question',
      'Необязательно: размер, цвет или вопрос'],
    ['Запит надіслано ✅', 'Request sent ✅', 'Запрос отправлен ✅'],
    ['Додати від себе — необовʼязково', 'Add something of your own — optional',
      'Добавить от себя — необязательно'],
    ['Розмір, колір або питання', 'Size, colour or a question', 'Размер, цвет или вопрос'],
    ['Запити на наявність і ціну', 'Availability & price requests', 'Запросы наличия и цены'],
    ['Ви ще нічого не питали. Додайте річ у примірочну і натисніть «Дізнатися наявність і ціну».',
    ...
    ['Телефон — обовʼязково з кодом країни: +380, +33, +1. Без нього ми не зможемо вам зателефонувати.',
      ...
      'Телефон — обязательно с кодом страны: +380, +33, +1. Без него мы не сможем вам позвонить.'],
    ['Вкажіть номер з кодом країни, наприклад +380 67 123 45 67.',
      'Enter the number with its country code, for example +380 67 123 45 67.',
      'Укажите номер с кодом страны, например +380 67 123 45 67.'],
    ['Перевірте номер: має бути код країни і 7–15 цифр, наприклад +380 67 123 45 67.',
      'Check the number: a country code and 7–15 digits, for example +380 67 123 45 67.',
      'Проверьте номер: код страны и 7–15 цифр, например +380 67 123 45 67.'],
    ['позиція', 'item', 'позиция'], ['позиції', 'items', 'позиции'], ['позицій', 'items', 'позиций'],
    ['Відправити', 'Send', 'Отправить'], ['Або напишіть', 'Or message', 'Или напишите'],
